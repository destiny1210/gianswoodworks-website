                    ...
                    <div className="wrapper contact-wrap  p-lg-5 p-4">
                      ...
                      <form id="contactForm" className="contactForm" onSubmit={handleSubmit}>
                        <div className="row">
                          ...
                          <div className="col-md-12">
                            <div className="form-group">
                              <input type="submit" value="Send Email" className="btn"/>                            </div>
                          </div>
                        </div>
                      </form>
                    </div>
    ...
    <section>
      <div className="info-wrap w-100 p-lg-5 p-4 img socials">
        ...
        <div className="dbox w-100 d-flex justify-content-center social-icon ">
          <a href="https://www.instagram.com/gians_woodworks/" class="social-links text-decoration-none">
        ...
        <div className="dbox w-100 d-flex justify-content-center social-icon">
          <a href="https://www.facebook.com/gianswoodworks" class="text-decoration-none social-links">
