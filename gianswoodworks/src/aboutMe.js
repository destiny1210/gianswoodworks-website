...
function Tab2Content() {
    ...
    <>
        ...
        {/* <div className="aboutMe-pic">
            <img src="https://www.shutterstock.com/image-photo/happy-young-family-one-child-260nw-761050711.jpg" alt="..."/>
        </div> */}
        <div className="aboutMe-paragraph">
            <p>
                Hi, my name is Giancarlo Manzaba and I’m the designer and craftsman at Gian’s
                Woodworks. I reside in San Antonio, TX, and serve all its’ surrounding areas.
            </p>
            <p>
            ...
            <p>
                ...
                imagination and my craftsman skills will deliver that and more.
            </p>
        </div>
    </>
